"""
Django settings for django_custom_start project.
...
SECRET_KEY = 'django-insecure-zxptu-&qwe9$!dq*q6td5)5+x3#uu2!ts8+!(q!07(9ylb)^si'
...
ROOT_URLCONF = 'django_custom_start.urls'
...
WSGI_APPLICATION = 'django_custom_start.wsgi.application'
